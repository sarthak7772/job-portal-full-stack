                    ...
                    <ul className='space-y-4 text-gray-600'>
                        {
                            JobCategories.map((category, index) => (
                                <li className='flex gap-3 items-center' key={index}>
                                    <input className='scale-115' type="checkbox" onChange={() => handleCategoryChange(category)}
                    ...
                    <ul className='space-y-4 text-gray-600'>
                        {
                            JobLocations.map((location, index) => (
                                <li className='flex gap-3 items-center' key={index}>
                                    <input className='scale-115' type="checkbox" onChange={() => handleLocationChange(location)}
